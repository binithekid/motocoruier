  ...
  return (
    <main className="w-full flex-col md:flex-row py-2 shadow relative px-4 sm:px-10 md:px-20 lg:px-30 bg-white flex justify-between items-center">
      ...
      <div className="flex flex-row md:mt-4  justify-center items-center">
        <div
          onClick={handleCall}
          className="px-4 py-3 bg-blue-900 flex-row gap-2 text-xl cursor-pointer hidden md:flex rounded-l font-medium hover:opacity-80 transition-all"
        >
        ...
        <div
          onClick={handleCall}
          className="px-4 py-3 bg-red-700 flex-row gap-2 text-xl cursor-pointer hidden md:flex rounded-r font-medium hover:opacity-80 transition-all"
        >
